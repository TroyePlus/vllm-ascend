...
from vllm_ascend.distributed.kv_transfer.kv_pool.ascend_store.attention_fence import publish_attention_compute_start_event
...
def fxrt_dsa_scatter_if_nonempty(
    ...
    if compressed_kv.shape[0] > 0:
        get_dsa_attn_kv_plan(cache_dtype=cache_dtype).dsa_kv_compress_scatter(
